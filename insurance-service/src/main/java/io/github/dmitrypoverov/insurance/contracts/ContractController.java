...
public class ContractController {
    ...
    ResponseEntity<ContractResponse> issue(@PathVariable UUID applicationId,
        ...
        ContractIssueResult result = contractIssuanceService.issue(applicationId, currentUser.subject());
    ...
    ContractResponse getById(@PathVariable UUID contractId,
        ...
        ContractDetails details = contractService.getById(contractId, currentUser);
    ...
    PagedModel<ContractResponse> list(@ParameterObject ContractFilter filter,
        ...
        Page<ContractDetails> page = contractService.find(currentUser, filter, pageable);
